!(function(e) {
        ...
        !(function(n, r) {
            ...
            var e =
                ...
                (function(e, t) {
                    ...
                    const f = (o.BufferedBlockAlgorithm = i.extend({
                        reset() {
                            (this._data = new a.init()), (this._nDataBytes = 0);
                        },
                        _append(e) {
                            typeof e === "string" && (e = l.parse(e)),
                                this._data.concat(e),
                ...
                o(e, null, [
                    ...
                    },
                    {
                        ...
                        value(e) {
                            ...
                            return `${e.getUTCFullYear()}-${t(
                                e.getUTCMonth() + 1
                            )}-${t(e.getUTCDate())}T${t(e.getUTCHours())}:${t(
                                e.getUTCMinutes()
                            )}:${t(e.getUTCSeconds())}Z`;
                        }
                    },
    ...
    function(e, t, n) {
        ...
        const p = (function() {
            function e(t) {
                o(this, e);
                const n = d.default.os.name;
                const r = d.default.os.version || "";
                const i = d.default.browser.name;
                const a = d.default.browser.version || "";
                            ...
                            value(e, t) {
                                ...
                                if (
                                    ...
                                    new Image(
                                        0,
                                        0
                                    ).src = `https://videocloud.cn-hangzhou.log.aliyuncs.com/logstores/upload/track?${a}`;
                                }
                            }
                        }
                    ],
    ...
    function(e, t, n) {
        ...
        const i = function(e) {
            ...
            return (
                o && (n = "macOS"),
                navigator.platform == "X11" && !r && !o && (n = "Unix"),
        ...
        const u = (function() {
            ...
            const o = n.match(/Web[kK]it[\/]{0,1}([\d.]+)/);
            const u = n.match(/(Android);?[\s\/]+([\d.]+)?/);
            const c = !!n.match(/\(Macintosh\; Intel /);
            const l = n.match(/(iPad).*OS\s([\d_]+)/);
            const f = n.match(/(iPod)(.*OS\s([\d_]+))?/);
            const h = !l && n.match(/(iPhone\sOS)\s([\d_]+)/);
            const d = n.match(/(webOS|hpwOS)[\s\/]([\d.]+)/);
            const p = /Win\d{2}|Windows/.test(r);
            const g = n.match(/Windows Phone ([\d.]+)/);
            const v = d && n.match(/TouchPad/);
            const y = n.match(/Kindle\/([\d.]+)/);
            const _ = n.match(/Silk\/([\d._]+)/);
            const m = n.match(/(BlackBerry).*Version\/([\d.]+)/);
            const T = n.match(/(BB10).*Version\/([\d.]+)/);
            const S = n.match(/(RIM\sTablet\sOS)\s([\d.]+)/);
            const w = n.match(/PlayBook/);
            const A = n.match(/Chrome\/([\d.]+)/) || n.match(/CriOS\/([\d.]+)/);
            const b = n.match(/Firefox\/([\d.]+)/);
            const I = n.match(
            ...
            const U =
                !A && n.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/);
            const k =
                U ||
                n.match(
                        ...
                        },
                        {
                            ...
                            value(t, n, r) {
                                ...
                                for (
                                    ...
                                    const l = e.aliyunEncodeURI(t[a[i]]);
                                    s == ""
                                        ? (s = c + n + l)
                                        : (s += r + c + n + l);
                                }
    ...
    function(e, t, n) {
        let r;
        let o;
        const i = (typeof Symbol === "function" && Symbol.iterator, n(14));
        const a = (function(e) {
            return e && e.__esModule ? e : { default: e };
        })(i);
        const s = { Vod: a.default };
        (r = []),
            void 0 !==
                (o = function() {
                    return s;
                    ...
                    i(e, [
                                                ...
                                                e => {
                                                    try {
                                                        if (
                                                            ...
                                                            c._invalidUserId = !0;
                                                            const t = `${e.Message}，正确账号ID(userId)请参考：https://help.aliyun.com/knowledge_detail/37196.html`;
                                                            console.log(t);
                                                        }
                                                    } catch (e) {
                                                        console.log(e);
                        ...
                        },
                        {
                            ...
                            value(e) {
                                ...
                                const n = y.default.getFileType(e.file.name);
                                let r = this._getCheckoutpoint(e);
                                let o = "";
                                let i = "";
                                r &&
                                    r.checkpoint &&
                            ...
                            value(e, t) {
                                if (t.name == "cancel") {
                                    ...
                                    if (
                                        ...
                                        t.code == "SecurityTokenExpired" ||
                                        t.code ==
                                            "InvalidSecurityToken.Expired" ||
                                        (t.code == "InvalidAccessKeyId" &&
                                            this._ossCreditor.securityToken)
                                    ) {
                                    ...
                                    if (
                                        (t.name == "RequestTimeoutError" ||
                                            t.name == "ConnectionTimeout" ||
                                            t.name ==
                        ...
                        },
                        {
                            ...
                            value(e, t) {
                                ...
                                t.headers && (o.headers = t.headers),
                                    ...
                                    e.bucket ||
                                        (this.oss.options.bucket = e.bucket),
                                    e.endpoint ||
    ...
    function(e, t, n) {
        (function(e) {
            ...
            function d(e, t) {
                ...
                if (t) {
                    if (
                        ...
                        return typeof t.length !== "number" || G(t.length)
                            ? o(e, 0)
                            : f(e, t);
                    }
                    if (t.type === "Buffer" && Q(t.data)) return f(e, t.data);
                }
                throw new TypeError(
            ...
            function m(e, t, n, r, o) {
                ...
                if (
                    (typeof t === "string" && (t = i.from(t, r)), i.isBuffer(t))
                )
                    return t.length === 0 ? -1 : T(e, t, n, r, o);
                if (typeof t === "number") {
                    return (
                        (t &= 255),
                        i.TYPED_ARRAY_SUPPORT &&
            ...
            function k(e, t, n) {
                ...
                for (var r = [], o = t; o < n; ) {
                    const i = e[o];
                    let a = null;
                    let s = i > 239 ? 4 : i > 223 ? 3 : i > 191 ? 2 : 1;
                    if (o + s <= n) {
                        var u;
                        var c;
                        var l;
    ...
    function(e, t) {
        (t.read = function(e, t, n, r, o) {
            ...
            (t.write = function(e, t, n, r, o, i) {
                ...
                const l = (1 << c) - 1;
                const f = l >> 1;
                const h = o === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
                let d = r ? 0 : i - 1;
                const p = r ? 1 : -1;
                ...
                i(e, null, [
                    {
                        ...
                        value(e, t, n) {
                            ...
                            const i = `${c.default.makeUTF8sort(
                                o,
                                "=",
                                "&"
                            )}&Signature=${c.default.aliyunEncodeURI(
                                c.default.makeChangeSiga(o, e.accessKeySecret)
                            )}`;
                            const a = `https://vod.${e.region}.aliyuncs.com/?${i}`;
                            s.default.get(
                                a,
                                e => {
                                    var e = JSON.parse(e);
                    ...
                    },
                    {
                        ...
                        value(e, t, n) {
                            ...
                            e.fileSize && (o.FileSize = e.fileSize),
                                ...
                                e.userData &&
                                    (o.UserData = JSON.stringify(e.userData));
                            const i = `${c.default.makeUTF8sort(
                                o,
                                "=",
                                "&"
                ...
                i(e, null, [
                    ...
                    },
                    {
                        ...
                        value(t, n, r) {
                            ...
                            const i = Math.floor(new Date().valueOf() / 1e3);
                            let a = f.default.getClientId();
                            a = f.default.setClientId(a);
                            const u = e.getAuthInfo(t.userId, a, i);
                            const l = y.default.randomUUID();
                            const h = {
                                Source: "WebSDK",
                                ...
                                DonePartsCount:
                                    t.checkpoint.checkpoint.doneParts.length,
                            ...
                            a && (h.ClientId = a);
                            const p = `${y.default.makeUTF8sort(
                                h,
                                "=",
                                "&"
                            )}&Signature=${y.default.aliyunEncodeURI(
                                y.default.makeChangeSiga(h, t.accessKeySecret)
                            )}`;
                            const v = `https://vod.${t.region}.aliyuncs.com/?${p}`;
                            s.default.get(
                                v,
                                e => {
                                    n && n();
